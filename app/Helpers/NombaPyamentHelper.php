...
class NombaPyamentHelper {
    ...
    {
        $AccountId = Setting::where(['slug' => 'nomba_account_id'])->first()->value;
        $client_id = Setting::where(['slug' => 'nomba_client_id'])->first()->value;
        $client_secret = Setting::where(['slug' => 'nomba_private_key'])->first()->value;
