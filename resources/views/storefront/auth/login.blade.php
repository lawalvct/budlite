...
@section('title', 'Login - ' . ($storeSettings->store_name ?? $tenant->name))
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-lg shadow-sm p-8">
                ...
                <form action="{{ route('storefront.login', $tenant->slug) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" aria-label="Toggle password visibility"
                                ...
                                <!-- Eye icon (visible) -->
                                <svg id="pw-eye-icon" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                @if($storeSettings->allow_email_registration)
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="{{ route('storefront.register', $tenant->slug) }}"
