...
@section('title', 'Employee Summary Report - ' . $tenant->name)
@section('page-title', 'Employee Summary Report')
@section('page-description', 'Detailed employee payroll statistics')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Employee Summary Report</h2>
            <p class="mt-1 text-sm text-gray-600">Comprehensive payroll statistics by employee</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="p-6">
            <form method="GET" action="{{ route('tenant.payroll.reports.employee-summary', $tenant) }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('tenant.payroll.reports.employee-summary', $tenant) }}"
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">₦{{ number_format($summary['total_deductions'], 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">₦{{ number_format($summary['total_tax'], 2) }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Employee Payroll Statistics</h3>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Pay Runs</th>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Total Net</th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Avg Net</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 text-right">
                                {{ number_format($data['payroll_count']) }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 text-right">
                                ₦{{ number_format($data['average_net'], 2) }}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        @else
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500">No employees match your current filters.</p>
            </div>
        @endif
    </div>
</div>
