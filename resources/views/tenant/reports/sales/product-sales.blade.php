...
@section('page-description')
    <span class="hidden md:inline">Detailed sales analysis by product with profit metrics</span>
@endsection
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold {{ $totalProfit >= 0 ? 'text-green-600' : 'text-red-600' }}">₦{{ number_format($totalProfit, 2) }}</p>
                </div>
            </div>
        </div>
    </div>
