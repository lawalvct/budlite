...
@section('page-title', 'Product Purchase Report')
@section('page-description')
    <span class="hidden md:inline">Detailed purchase analysis by product with cost metrics</span>
@endsection
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Products Purchased</p>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <select name="product_id" id="product_id" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
            ...
            <div>
                ...
                <select name="category_id" id="category_id" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
            ...
            <div>
                ...
                <select name="sort_by" id="sort_by" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    ...
                    <option value="quantity_purchased" {{ $sortBy === 'quantity_purchased' ? 'selected' : '' }}>Quantity</option>
                    <option value="purchase_count" {{ $sortBy === 'purchase_count' ? 'selected' : '' }}>Purchase Count</option>
                </select>
            </div>
            <div class="flex items-end">
                <button type="submit" class="w-full inline-flex justify-center items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Product Purchase Details</h3>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Qty Purchased</th>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Min Cost</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Max Cost</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($productPurchases as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{{ number_format($product->quantity_purchased, 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 text-right">₦{{ number_format($product->total_cost, 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">₦{{ number_format($product->avg_purchase_price, 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">₦{{ number_format($product->min_purchase_price, 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">₦{{ number_format($product->max_purchase_price, 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">{{ number_format($product->purchase_count) }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-gray-500">No product purchase data found for the selected period</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                ...
                @if($productPurchases->count() > 0)
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">{{ number_format($productPurchases->sum('quantity_purchased'), 2) }}</td>
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">₦{{ number_format($productPurchases->sum('total_cost'), 2) }}</td>
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">-</td>
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">-</td>
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">-</td>
                            <td class="px-6 py-3 text-sm font-bold text-gray-900 text-right">{{ number_format($productPurchases->sum('purchase_count')) }}</td>
                        </tr>
                    </tfoot>
                @endif
            </table>
