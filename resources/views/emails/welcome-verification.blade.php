...
<head>
    ...
    <title>Verify Your Email - Budlite</title>
    <style>
        body {
    ...
    <div class="email-wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Thank you for registering with <strong class="highlight">Budlite</strong>. We're excited to have you on board!</p>
                ...
                <!-- Security Alert -->
                <div class="alert-box">
                    <p><strong>⚠️ Didn't create an account?</strong> If you didn't register for a Budlite account, please ignore this email. No further action is required and your email won't be used.</p>
                </div>

                <!-- Info Box -->
                <div class="info-box">
                    <p><strong>💡 Need Help?</strong> If you're experiencing any issues or have questions, our support team is here to help. Contact us at <a href="mailto:support@budlitee.ngm" style="color: #2b6399; font-weight: 600;">supportbudlitete.ngm</a></p>
                </div>

                <div class="divider"></div>

                <p style="margin-bottom: 0;">We're thrilled to have you join the Budlite community. Let's get your business organized and growing!</p>
            </div>
